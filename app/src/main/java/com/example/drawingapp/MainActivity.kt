...
class MainActivity : AppCompatActivity() {
    ...
    val requestPermission : ActivityResultLauncher<Array<String>> =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            permissons.entries.forEach{
                ...
                if(isGranted){
                    Toast.makeText(this@MainActivity, "Permission granted you can read the storage files",
                        Toast.LENGTH_LONG)
                        .show()
    ...
    private fun showBrushSizeChooserDialog(){
        ...
        val mediumLargeBtn : ImageButton = brushDialog.findViewById(R.id.ib_medium_large_brush)
        mediumLargeBtn.setOnClickListener{
